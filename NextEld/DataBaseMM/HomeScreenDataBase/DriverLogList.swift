...
struct DriverLogHeader: View {
    ...
    var body: some View {
        ...
        HStack(spacing: 5) {
            ...
            TableCell(text: "Vehicle", width: 200,isHeader: true)
...
struct DriverLogRow: View {
    ...
    var body: some View {
        ...
        HStack(spacing: 5) {
            ...
            TableCell(text: log.vehicle, width: 200)
            ...
            TableCell(text: "\(log.remainingWeeklyTime ?? 0)" , width: 220)
            TableCell(text: "\(log.remainingDriveTime ?? 0)", width: 220)
            TableCell(text: "\(log.remainingDutyTime ?? 0)", width: 220)
            TableCell(text: "\(log.remainingSleepTime ?? 0)", width: 220)
