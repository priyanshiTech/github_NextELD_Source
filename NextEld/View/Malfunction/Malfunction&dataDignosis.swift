...
//
//        os_log("NEW ODO: %.2f miles | OLD ODO: %.2f miles | ENG HRS: %.2f",
//               odometerMiles,
//               previousOdometerMiles,
//               previousEngineHours)
//
//        // Valid ECM data check
//        if currentEngineHours > previousEngineHours && odometerMiles > previousOdometerMiles {
//            onValidEngineData()
//        }
//
...
//        previousEngineHours = currentEngineHours
//    }*/
//    
//    private func processECMData(
//        currentOdometerKM: Double,
...
//
//        case .malfunctionStarted:
//            status = "Engine Sync Malfunction"
