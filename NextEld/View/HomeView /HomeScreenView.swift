...
//MARK: -  For Delete API's
    ...
    @State private var warningBeforeEnd1: Double = 1800 // default 30 min
...
//                                }
    ...
    // MARK: - OnDuty Timer Violation Logic with Working Time
               ...
               // MARK: - Drive Timer Violation Logic with Working Time
        ...
        .onReceive(ONDuty.$remainingTime) { remainingTime in
            ...
            let warningAt30Min = Double(totalDriveTime) - warningBeforeEnd1
            let warningAt15Min = Double(totalDriveTime) - warningBeforeEnd2
