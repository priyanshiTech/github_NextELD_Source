...
//    @State private var didShowCycleViolation = false
    // Replace your current @State declarations (around line 385-387) with these:
    @State private var didShow30MinWarning = false
    @State private var didShow15MinWarning = false
    @State private var didShowViolation = false
...
//                        message: "Your Onduty time has been exceeded to 11 hours",
//                        backgroundColor: .red.opacity(0.9),
//                        isViolation: true
//                    )
//                    didShowViolation = true
//                    addViolationBox(text: "Your On Duty time has been exceeded to 11 hours")
//                    print("Violation fired once")
//
//                    saveViolationToDatabase(status: "Violation", DutyType: "Your On-Duty time has been exceeded to 11 hours \(times.local) ,GMT:\(times.gmt) ", isVoilation: true)
//                } else {
