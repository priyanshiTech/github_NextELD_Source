...
//            let normalizedStatus = normalizeStatus(log.status)
//
//            let localStartTime = log.startTime.toLocal()
//            let localEndTime = log.endTime.toLocal()
//
//            return HOSEvent(
//                id: log.id,
//                x: localStartTime,
...
extension Date {
    func toLocal() -> Date { self }  // Just return as-is; Swift handles timezones internally
}
